...
surfing2 = Activity.create!(name:"surfing", location: "durban", description: "North Beach", capacity: 10, price: 0, duration: 1, category: "Surfing", employee_id: sandra.id)
cycling2 = Activity.create!(name:"cycling", location: "Pretoria", description: "On the N1", capacity: 100, price: 0, duration: 8, category: "Cycling", employee_id: sandra.id)
...
wednesday = Availability.create!(activity_id: surfing2.id, employee_id: sandra.id, start_time: "2017-11-28T05:00:00.000Z", end_time: "2017-11-28T06:00:00.000Z")
thursday = Availability.create!(activity_id: cycling2.id, employee_id: sandra.id, start_time: "2017-11-23T04:00:00.000Z", end_time: "2017-11-23T12:00:00.000Z")
